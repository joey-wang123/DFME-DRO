...
from network.noise_layer_weight import noise_Conv2d
...
class Bottle2neck(nn.Module):
    def __init__(self, inplanes, planes, stride=1, hidden_planes=9, scale = 1, batch_size=5, new = 1.0):
        """ Constructor
        Args:
...
class Res2Net_weight(torch.nn.Module):
    def __init__(self, epsilon=1.0, hidden_planes=16, batch_size=5):
        super(Res2Net_weight, self).__init__()
        
        self.epsilon = epsilon
        self.hidden_planes = hidden_planes
                
        self.block1 = Bottle2neck(3, 3, hidden_planes=hidden_planes, batch_size=batch_size, new = self.epsilon)
        self.block2 = Bottle2neck(3, 3, hidden_planes=hidden_planes, batch_size=batch_size, new = self.epsilon)
