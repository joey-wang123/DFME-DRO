...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['MNIST','cifar10', 'cifar100'], help='dataset name (default: cifar10)')
    ...
    if args.model == 'resnet34_8x':
        ...
        teacher = get_classifier_cifar(args.model, pretrained=True, num_classes=args.num_classes)
        teacher.load_state_dict( torch.load( args.ckpt, map_location=device) )
    ...
    num_student = count_parameters(student)
    print('number of parameters student network', num_student)
